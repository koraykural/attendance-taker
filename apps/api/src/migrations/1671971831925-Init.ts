...
export class Init1671971831925 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "session_attendees" ("sessionId" character varying NOT NULL, "userId" character varying NOT NULL, "attendedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_841b2c90351ba011fdc81fc97fe" PRIMARY KEY ("sessionId", "userId"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "session_attendees" ADD CONSTRAINT "FK_8144e6c7c54c8460fd6de15e510" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "session_attendees" ADD CONSTRAINT "FK_701b326200475de4660038a8d40" FOREIGN KEY ("sessionId") REFERENCES "sessions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "session_attendees" DROP CONSTRAINT "FK_701b326200475de4660038a8d40"`
    );
    await queryRunner.query(
      `ALTER TABLE "session_attendees" DROP CONSTRAINT "FK_8144e6c7c54c8460fd6de15e510"`
    );
    await queryRunner.query(
